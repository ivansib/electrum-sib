...
version = imp.load_source('version', 'electrum_sibcoin/version.py')

if sys.version_info[:3] < (3, 4, 0):
    sys.exit("Error: Sibcoin-Electrum requires Python version >= 3.4.0...")
...
class CustomInstallCommand(install):
    def run(self):
        ...
        try:
            ...
            try:
                path = os.path.join(self.install_lib, "electrum_sibcoin/gui/qt/icons_rc.py")
