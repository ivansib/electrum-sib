...
;Interface Settings
  ...
  !define MUI_ICON "electrum_sibcoin\gui\icons\electrum-dash.ico"
...
Section
  ...
  File "electrum-sib\gui\icons\electrum-sibcoin.ico"
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrum-sibcoin.ico"
