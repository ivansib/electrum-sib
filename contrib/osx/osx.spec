...
PACKAGE='Electrum'
PYPKG='electrum_sibcoin'
MAIN_SCRIPT='electrum-sibcoin'
ICONS_FILE=PYPKG + 'icons/electrum-sibcoin.icns'
...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrum_sibcoin/gui/qt/main_window.py',
              electrum+'electrum_sibcoin/gui/text.py',
              electrum+'electrum_sibcoin/util.py',
              electrum+'electrum_sibcoin/wallet.py',
              electrum+'electrum_sibcoin/simple_config.py',
              electrum+'electrum_sibcoin/bitcoin.py',
              electrum+'electrum_sibcoin/dnssec.py',
              electrum+'electrum_sibcoin/commands.py',
              electrum+'electrum_sibcoin/plugins/cosigner_pool/qt.py',
              electrum+'electrum_sibcoin/plugins/email_requests/qt.py',
              electrum+'electrum_sibcoin/plugins/trezor/qt.py',
              electrum+'electrum_sibcoin/plugins/safe_t/client.py',
              electrum+'electrum_sibcoin/plugins/safe_t/qt.py',
              electrum+'electrum_sibcoin/plugins/keepkey/qt.py',
              electrum+'electrum_sibcoin/plugins/ledger/qt.py',
              ],
             binaries=binaries,
             datas=datas,
