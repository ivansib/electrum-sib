...
from electrum_sibcoin.i18n import _, languages
from electrum_sibcoin.util import (FileImportFailed, FileExportFailed,
                           resource_path)
from electrum_sibcoin.paymentrequest import PR_UNPAID, PR_PAID, PR_EXPIRED
...
class ColorScheme:
    ...
    DEFAULT = ColorSchemeItem("#818181", "#818181")
