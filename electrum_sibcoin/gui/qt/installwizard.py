...
from electrum_sibcoin.wallet import Wallet, Abstract_Wallet
from electrum_sibcoin.storage import WalletStorage
from electrum_sibcoin.util import UserCancelled, InvalidPassword, WalletFileException
from electrum_sibcoin.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
WIF_HELP_TEXT = (_('WIF keys are typed in Sibcoin Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
...
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              ...
                              + _("Due to a bug, old versions of Sibcoin Electrum will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins):
        ...
        self.setWindowTitle('Sibcoin-Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon('electrum-sibcoin.png')
        self.show()
        self.raise_()
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Sibcoin-Electrum wallet'))
    ...
    def run_upgrades(self, storage):
        ...
        if storage.requires_split():
            self.hide()
            msg = _("The wallet '{}' contains multiple accounts, which are no longer supported since Sibcoin-Electrum 2.7.\n\n"
    ...
    def init_network(self, network):
        message = _("Sibcoin-Electrum communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Sibcoin-Electrum "
