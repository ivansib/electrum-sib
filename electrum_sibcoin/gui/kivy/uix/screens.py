...
from electrum_sibcoin.util import send_exception_to_crash_reporter
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file('electrum_sibcoin/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_hash, tx_type, tx_mined_status, value, balance):
        ...
        icon = "atlas://electrum_sibcoin/gui/kivy/theming/light/" + TX_ICONS[status]
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from electrum_sibcoin.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_sibcoin.util import create_URI
