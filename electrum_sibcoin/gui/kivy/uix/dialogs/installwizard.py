...
from electrum_sibcoin.base_wizard import BaseWizard
from electrum_sibcoin.util import is_valid_email
...
<WizardTextInput@TextInput>
    ...
    background_active: 'atlas://electrum_sibcoin/gui/kivy/theming/light/create_act_text_active'
    background_normal: 'atlas://electrum_sibcoin/gui/kivy/theming/light/create_act_text_active'
    size_hint_y: None
    height: '48sp'
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            Label:
                ...
                text: 'SIBCOIN ELECTRUM'
                size_hint: 1, None
                height: self.texture_size[1] if self.opacity else 0
                font_size: '33sp'
                font_name: 'electrum_sibcoin/gui/kivy/data/fonts/tron/Tr2n.ttf'
        GridLayout:
            cols: 1
            id: crcontent
            spacing: '1dp'
...
<SeedButton@Button>:
    ...
    color: .1, .1, .1, 1
    background_normal: 'atlas://electrum_sibcoin/gui/kivy/theming/light/white_bg_round_top'
...
<AddXpubDialog>
    ...
    GridLayout
        ...
        IconButton:
            ...
            icon: 'atlas://electrum_sibcoin/gui/kivy/theming/light/camera'
            size_hint: 1, None
        WizardButton:
            text: _('Paste')
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_sibcoin.old_mnemonic import words as old_wordlist
...
class InstallWizard(BaseWizard, Widget):
    ...
    def waiting_dialog(self, task, msg, on_finished=None):
        ...
        app.show_info_bubble(
            text=msg, icon='atlas://electrum_sibcoin/gui/kivy/theming/light/important',
