...
from electrum_sibcoin.util import base_units_list
...
from electrum_sibcoin import coinchooser
...
<SettingsDialog@Popup>
    id: settings
    title: _('Sibcoin-Electrum Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Sibcoin amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_sibcoin/gui/kivy/uix/ui_screens/proxy.kv')
