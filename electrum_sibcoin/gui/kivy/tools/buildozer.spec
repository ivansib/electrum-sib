...
source.exclude_dirs = bin, build, dist, contrib, electrum_sibcoin/gui/qt, electrum_sibcoin/gui/kivy/tools, electrum_sibcoin/gui/kivy/theming/light
# (list) List of exclusions using pattern matching
source.exclude_patterns = Makefile,setup*

# (str) Application versioning (method 1)
version.regex = APK_VERSION = '(.*)'
version.filename = %(source.dir)s/electrum_sibcoin/version.py

# (str) Application versioning (method 2)
#version = 1.9.8

# (list) Application requirements
requirements = python3crystax==3.6, android, openssl, plyer, pyjnius==1.1.2, kivy_local==master, libsecp256k1, x11_hash
...
icon.filename = %(source.dir)s/icons/electrum-sibcoin.png
...
android.add_src = electrum_sibcoin/gui/kivy/data/java-classes/
...
android.manifest.intent_filters = electrum_sibcoin/gui/kivy/tools/bitcoin_intent.xml
