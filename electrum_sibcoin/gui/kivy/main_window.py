...
from electrum_sibcoin.wallet import Wallet, InternalAddressCorruption
from electrum_sibcoin.paymentrequest import InvoiceStore
from electrum_sibcoin.util import profiler, InvalidPassword, send_exception_to_crash_reporter
from electrum_sibcoin.plugin import run_hook
from electrum_sibcoin.util import format_satoshis, format_satoshis_plain
...
#Factory.register('InstallWizard', module='electrum_sibcoin.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_sibcoin.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_sibcoin.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_sibcoin.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_sibcoin_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_sibcoin.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrum_sibcoin/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_sibcoin/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_sibcoin/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_sibcoin/gui/kivy/data/fonts/Roboto-Bold.ttf')


from electrum_sibcoin.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrum_sibcoin.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_sibcoin.transaction import Transaction
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_sibcoin.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('electrum_sibcoin/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def build(self):
        return Builder.load_file('electrum_sibcoin/gui/kivy/main.kv')
    ...
    def show_tor_warning(self):
        ...
        img_error = 'atlas://electrum_sibcoin/gui/kivy/theming/light/error'
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_sibcoin/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_sibcoin.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_sibcoin.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_sibcoin_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_sibcoin_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_sibcoin/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_sibcoin/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_sibcoin/gui/kivy/theming/light/card'
        else:
