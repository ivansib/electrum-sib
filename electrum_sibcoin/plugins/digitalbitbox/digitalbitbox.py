...
from electrum_sibcoin.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_sibcoin.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                                   is_address)
from electrum_sibcoin.bip32 import serialize_xpub, deserialize_xpub
from electrum_sibcoin import ecc
from electrum_sibcoin.ecc import msg_magic
from electrum_sibcoin.wallet import Standard_Wallet
...
from electrum_sibcoin.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from electrum_sibcoin.util import print_error, to_string, UserCancelled, UserFacingException
from electrum_sibcoin.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Sibcoin-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
