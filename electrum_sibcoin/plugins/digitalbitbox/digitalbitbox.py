...
try:
    from electrum_sibcoin.crypto import Hash, EncodeAES, DecodeAES
    from electrum_sibcoin.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh, is_address,
    ...
    from electrum_sibcoin.util import print_error, to_string, UserCancelled
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        msg = ('{"seed":{"source": "create", "key": "%s", "filename": "%s", "entropy": "%s"}}' % (key, filename, 'Digital Bitbox Sibcoin-Electrum Plugin')).encode('utf8')
