...
from electrum_sibcoin.util import bfh, bh2u, UserCancelled
from electrum_sibcoin.bitcoin import (b58_address_to_hash160, xpub_from_pubkey,
...
class KeepKeyPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "SibcoinTestnet" if constants.net.TESTNET else "Sibcoin"
