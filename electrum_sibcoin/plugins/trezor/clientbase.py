...
from electrum_sibcoin.util import UserCancelled, UserFacingException
from electrum_sibcoin.keystore import bip39_normalize_passphrase
from electrum_sibcoin.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32 as parse_path
from electrum_sibcoin.logging import Logger
from electrum_sibcoin.plugins.hw_wallet.plugin import OutdatedHwFirmwareException
...
class TrezorClientBase(Logger):
    ...
    def has_usable_connection_with_device(self):
        ...
        try:
            res = self.client.ping("electrum-sibcoin pinging device")
    ...
    def get_passphrase(self):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the Sibcoin coins in the wallet.").format(self.device)
        else:
