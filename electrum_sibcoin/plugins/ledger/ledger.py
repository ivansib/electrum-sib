...
from electrum_sibcoin.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
                                   b58_address_to_hash160,
                                   hash160_to_b58_address)
from electrum_sibcoin.i18n import _
from electrum_sibcoin.plugin import BasePlugin
...
from electrum_sibcoin.util import print_error, bfh, bh2u, versiontuple
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in Sibcoin mode")) from e
                raise e
